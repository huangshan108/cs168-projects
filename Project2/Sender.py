    ...
    def start(self):
        ...
        while True:
            ...
            if message == None:
                ...
                self.duplicates = 0
                continue
            if self.get_ack_type(message) != "sack" and self.sackMode:
                continue
            if self.get_ack_type(message) != "ack" and not self.sackMode:
                continue
            if self.sackMode:
            ...
            if returnedMessage == "Forward":
                ...
                for i in range(self.seqNum, ackSeqNum):
                    del self.sentPackets[i]
